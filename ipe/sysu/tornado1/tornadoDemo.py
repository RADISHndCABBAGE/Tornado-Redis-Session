...
class Session(object):
    ...
    '''
    session_id作为cookie中获取self._id的键，而self._id作为session中获取二级字典的键。（session是一级字典，每个键 _id
    对应的值是二级字典
...
class LoginHandler(BaseHandler):
    ...
    def post(self, *args, **kwargs):
        ...
        if username == 'wupeiqi' and password == '123':
            ...
            self.my_session['is_login'] = 'true'#这里 'is_loging'和'true'是二级键值对。一级键值对的键是自动生成的._id
